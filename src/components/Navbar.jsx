    ...
    <div className='flex fixed min-w-screen justify-center items-center backdrop-blur-sm text-white z-10'>
      <div className='grid grid-cols-[1fr_1fr_1fr] bg-linear-to-r from-[#1C1924] via-[#1E212A] to-[#1C272A] w-full h-12 justify-center items-center rounded-sm'>
        <div className='flex justify-start items-center'>
          <img className='my-2 mx-4 w-5' src="/icons/burger_menu.svg" alt="" />
          <img className='my-2 ml-7  w-5' src="/icons/logo.svg" alt="" />
          <img className='my-2 mx-2' src="/icons/logo_name.svg" alt="" />
        </div>
          ...
          <div className='flex w-full justify-between'>
            <div className='w-full flex items-center justify-between h-9 bg-[#3D464D] px-1 rounded-full border-none text-sm'>
              ...
              <button className='flex h-7 items-center relative z-10 justify-center'>
                <img className='h-8' src="/icons/search_icon.svg" alt="" />
              </button>
            </div>
          </div>
          <a className='flex items-center w-8 ml-1' href=""><img src="/icons/mic_icon.svg" alt="" /><input type="text" id='voiceInput' /></a>
        </div>
        <div className='flex justify-end px-20 h-7'>
          <div className='flex gap-x-6 justify-center items-center'>
            <img className='h-5' src="/icons/create_icon.svg" alt="" />
            <img className='h-5' src="/icons/notification_icon.svg" alt="" />
            <img className='h-6' src="/icons/profile_icon.svg" alt="" />
          </div>
        </div>
      </div>
    </div>
