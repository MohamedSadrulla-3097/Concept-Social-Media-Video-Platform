        ...
        <div className='flex flex-row w-355 h-full ml-18 p-2 overflow-y-visible'>
          <div className='grid grid-cols-[1fr_1fr_1fr] w-full'>
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2  h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'><img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_1.png" alt="" /></div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt="" />
                ...
                <div className='flex flex-col w-30 items-end  ml-7 text-sm  text-white'>
                  <img className='w-4 mr-10' src="/icons/logo.svg" alt="" />
                  Sketch Minds
                </div>
              </div>
            </div>
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_2.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_3.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
                ...
                <div className='flex flex-col w-30 items-end ml-7 text-sm text-white'>
                  <img className='w-4 mr-7' src="/icons/logo.svg" alt='' />
                  Chef Nova
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_4.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
                ...
                <div className='flex flex-col w-30 items-end text-sm text-white'>
                  <img className='w-4 mr-5' src="/icons/logo.svg" alt='' />
                  DevOps
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_5.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
                ...
                <div className='flex flex-col w-30 items-end text-sm text-white'>
                  <img className='w-4 mr-6' src="/icons/logo.svg" alt='' />
                  Zen Shift
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_6.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_7.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_8.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_9.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_10.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_11.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white '>
            ...
            <div className='flex flex-col bg-white/5 backdrop-blur-3xl m-2 h-75 rounded-xl hover:scale-102 transition-all cursor-pointer'>
              <div className='bg-amber-100 h-60 rounded-sm'>
                <img className='h-60 rounded-sm w-full' src="/thumbnails/thumb_12.png" alt="" />
              </div>
              <div className='flex relative w-full text-3xl items-center my-2 text-white'>
                <img className='h-7 flex pl-5' src="/icons/save_icon.svg" alt='' />
                <div className='text-sm mx-5 flex items-center text-white'>
